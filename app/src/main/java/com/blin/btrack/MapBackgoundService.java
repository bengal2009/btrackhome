 ...
 */
public class MapBackgoundService extends Service implements
        SendTagMsgAsyncTask.OnSendTagScuessListener
        ,CurLoc.OnCurSendScuessListener{

    private static final int BACK_GROUND_NOTIFICATION_ID = 1620;
...
//					issueNotificationWithBind(context, userId, channelId);
    ...
    BroadcastReceiver networkReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i("网路", noNetworkAvailable ? "?有网" : "有网");
...
*/
    ...
    Style newInboxStyle(String userId,String channelId) {
        ...
        inboxStyle.setSummaryText("推送服?已确定");
...
//		notif(getApplicationContext(), "后台服?","推送后台正在?定！...");
    }
